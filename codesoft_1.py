...
class todo:
    def __init__(self,root):
        ...
        self.root.geometry('650x10+300+150')

        self.label = Label(self.root, text='To-do-List-App-By-Vinayak',
              font='ariel,25 ', width=10,bd=5, bg='yellow',fg='black')
        self.label.pack(side='top',fill=BOTH)

        self.label2 = Label(self.root, text='Add Task',
              font='ariel,18 ', width=10,bd=5, bg='red',fg='black')
        ...
        self.button = Button(self.root, text="Add", font='sarif,20',
                             width=10,bd=5, bg='red', fg='black', command=add)
